...
class _JobAddScreenState extends State<JobAddScreen> {
  ...
  void initState() {
    ...
    if (widget.routeArgument != null) {
      ...
      // _titleController.text = "we need senior engineer";
      // _descriptionController.text = "please send cv";
    }
  ...
  void _onAddButtonPressed() {
    if (_formKey!.currentState!.validate()) {
      if (!_company!.profileCompleted()) {
        ...
        _jobsBloc.add(JobAddEvent(model: _model, company: _company!));
      }
    }
  }
