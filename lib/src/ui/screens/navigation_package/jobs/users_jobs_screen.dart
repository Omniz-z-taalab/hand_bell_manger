...
import 'package:hand_bill_manger/src/ui/screens/navigation_package/jobs/component/jobs_user_widget.dart';
import 'package:hand_bill_manger/src/ui/screens/navigation_package/jobs/my_jobs_screen.dart';

class UsersJobsScreen extends StatefulWidget {
  static const routeName = "/UsersJobsScreen";

  @override
  _UsersJobsScreenState createState() => _UsersJobsScreenState();
}

class _UsersJobsScreenState extends State<UsersJobsScreen> {
  ...
  void initState() {
    ...
    _jobsBloc.allPage = 1;
    _jobsBloc..add(FetchUsersJobsEvent(company: _company));
        ...
        body: RefreshIndicator(
            ...
            child: BlocListener<JobsBloc, JobsState>(
                listener: (context, state) {
                  ...
                  if (state is AllJobSuccessState) {
                    setState(() {
                      if (_items == null) {
                        _items = [];
                      }
