...
class CompanyWidget extends StatelessWidget {
  ...
  CompanyWidget({required this.model});
                  ...
                  child: Stack(fit: StackFit.loose, children: [
                    Container(
                      ...
                      child: CachedNetworkImage(
                          imageUrl: model.images!.isEmpty
                              ? placeholder_concat
                              : APIData.domainLink + model.images![0].url!,
                          fit: BoxFit.cover,
                    ...
                    Positioned(
                        ...
                        child: Container(
                            ...
                            child: CachedNetworkImage(
                                imageUrl: model.leftDataOfCompanies == null
                                    ? placeholder_concat
                                    : APIData.domainLink + model.flag!,
                                fit: BoxFit.fill,
                                width: 24,
                                height: 24))),
                    Positioned(
